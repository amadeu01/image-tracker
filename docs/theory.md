...
| 11.4 (planned) | Strategy benchmark: filter chain (none / Gaussian / median) × tracker kind (template / color) on a fixed ~200-frame segment | *pending* | §5 (filter theory); results to be appended here once the task lands |
